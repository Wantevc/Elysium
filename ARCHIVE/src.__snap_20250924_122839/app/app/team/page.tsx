...
/** mini helpers – lokaal opslaan tot je backend klaar is */
...
export default function TeamSeatsPage() {
  ...
  return (
    <PageShell title="Team Seats" desc="Beheer teamleden binnen je Diamond-plan.">
      <DiamondOnly>
        <Card>
          <SectionTitle title="Team" desc="Nodig tot 3 extra teamleden uit (Diamond). Ze delen dezelfde workspace en credits." />
