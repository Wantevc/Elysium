...
export default function TemplatesPage() {
  ...
  async function save() {
    ...
    try {
      ...
      setErr(e?.error || e?.message || " mislukt");
    }
  }
          ...
          {form && (
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <button onClick={save} className="px-3 py-2 rounded-2xl shadow bg-gray-900 text-white"></button>
                {form.id && (
                  <button onClick={() => del(form.id!)} className="px-3 py-2 rounded-2xl shadow bg-white hover:bg-gray-100"></button>
                )}
              </div>
