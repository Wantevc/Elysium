...
async function doGenerate(mode: "gen" | "variant") {
  ...
  <SectionTitle
    title="Input"
    desc="Beschrijf de gewenste visual en de tekst die op het beeld moet komen."
  />
  ...
  <div className="grid-2">
    ...
    <div style={{ gridColumn: "1 / -1" }}>
      ...
      <textarea
        ...
        placeholder='bv. "A Forrest in the winter with a soft feeling and a man holding a board that says " Welcome"'
      />
    </div>

    {/* Tekst op beeld */}
    <div>
      <label className="label">Thema / Feeling</label>
      <input
        className="input"
        value={offer}
        onChange={(e) => setOffer(e.target.value)}
        placeholder='bv. "Ice Cold / Sunny days"'
      />
    </div>
  </div>
...
<Card>
  <SectionTitle
    title="Preview"
    desc="Controleer je resultaat en download als PNG."
  />
  <div
    className="card"
    style={{
